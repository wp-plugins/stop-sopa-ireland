...
if(!is_admin()) add_action('init', 'add_sopa_jquery');
...
function add_sopa_menubar_footer(){
    echo '<div id="sopa_menubar">
            <ul>
                <li class="sopa_title"><strong>Visit your TD &amp; STOP SOPA IRELAND!</strong></li>
                <li><a class="sopa_sign" href="http://stopsopaireland.com/"><strong>Add your pledge</strong></a></li>
